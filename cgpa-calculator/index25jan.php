        ...
        <div class="main">
            ...
            <div class="lbody">
                <div class="addcontainer bar1 shadow cgpa">
                    ...
                    if (isset($_REQUEST['course'])) {
                        ...
                        $courses = $courseC = $_REQUEST['course'];
                        $credits = $creditC = $_REQUEST['credit'];
                        $grades = $gradeC = $_REQUEST['grade'];
                        ...
                        if (!isset($_REQUEST['submit'])) {
                            if ($islogged == 1) {
                                ...
                                $uid = $userr[0]['id'];
                                $courses = $courseC = json_decode($userr[0]['courses']);
                                $credits = $creditC = json_decode($userr[0]['credits']);
                                $grades = $gradeC = json_decode($userr[0]['grades']);
                            }
                        }


                        /* CGPA Calculating Part ...................................................................*/


                        for ($i = 0; $i < sizeof($creditC); $i++) {

                            $k = array_search($courseC[$i], $courseC);
                            if (getPoint($gradeC[$i]) < getPoint($gradeC[$k]))
                                $creditC[$i] = 0;
                        }


                        for ($i = sizeof($creditC); $i >= 0; $i--) {
                        ...
                        for ($i = 0; $i < sizeof($creditC); $i++) {
                            $subGrade += $creditC[$i] * getPoint($gradeC[$i]);
                            $totalCredits += $creditC[$i];
                        }
          ...
          <td> <a href="javascript:void(0)" class="removeCourse"> <i class="fa fa-window-close bsiz"></i></a></td></tr></tbody></table>
                        ...
                        <div class="tips">
                            <br/>
                            <ul>
                                <li>Add course initials twice with previous grades if you've retaken. Best grade will be
                                    counted only and credit will be adjusted automatically.
                                </li>
                            </ul>
                        </div>
      ...
      if(screen.width<600){
       document.getElementById('anaTop').scrollIntoView();
                ...
                <div class="addcontainer bar1 shadow gradingc">
                    The most advanced CGPA calculator for North South University, Bangladesh. GPA calculation is
