...
if(screen.width<600){
   document.getElementById('anaTop').scrollIntoView();
        ...
        <div class="addcontainer bar1 shadow gradingc">
            The most advanced CGPA calculator for North South University, Bangladesh. GPA calculation is followed by the
            official grading system of NSU. You can calculate your CGPA just by entering the credits and grades. If you
            are a registered user then CGPA data will be saved on your account, so that you won't have to enter the
            grades again in future.
        </div>
