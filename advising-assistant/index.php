...
$dmeta = '<meta name="description" content="Advising Assistant is an advanced tool that allows the student to search for specific courses with their section, time. Besides, logged users can select multiple courses and get real time information such as capacity of those targeted courses only. This tool\'s data gets updated in every 60 seconds from North South University\'s official offered courses page."/>';


$title = 'Advising Assistant - Advanced Offered Course List of NSU';
...
?>
    ...
    <div class="tabDetails bar1">
        <div id="tab1" class="tabContents">
            ...
            <form class="sForm" action="/advising-assistant/index.php" method="GET">
...
if (!empty($_GET['course'])) {
    ...
    echo '<a style="display: block; padding: 10px 15px; background: #023d6f; color: #fff; margin-bottom: 15px; border-radius: 5px;" href="/advising-assistant/">Go back from Search <i class="fa fa-arrow-circle-o-left fa-2" style="float: right; font-size: 20px;"></i></a>';
...
?>
    ...
    <div class="tabDetails bar1" style="background: #fff;border-top-left-radius: 0px; border; padding: 20px;">
        ...
        <div class="lbody">
            ...
            <form class="sForm" action="/advising-assistant/addcourse.php" method="GET">
...
?>
    ...
    <div class="sidebar">
        ...
        <div class="addcontainer bar1 shadow">
            <h2>What is it</h2>
            Advising Assistant is an advanced tool that allows the student to search for specific courses with section,
            time and course name itself. Besides, logged users can select multiple courses and get real-time information
            such
            as capacity/seats of those targeted courses only. This tool's data gets updated in every 60 seconds from
            NSU's official <b>Offered Courses List</b> page.
        </div>
