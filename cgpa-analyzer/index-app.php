...
<td> <a href="javascript:void(0)" class="removeCourse"> <i class="fa fa-window-close bsiz"></i></a></td></tr></tbody></table>
        ...
        <div class="tips">
            <br/>
            <ul>
                <li>Add course initials twice with previous grades if you are retaking. Best grade will be counted only
                    and credit will be adjusted automatically.
                </li>
...
if(screen.width<600){
   document.getElementById('anaTop').scrollIntoView();
    ...
    <div class="addcontainer bar1 shadow gradingc">
        ...
        targeted CGPA. Just set a target for your CGPA, enter your current CGPA and courses of current semester. This
        program will analyze the data and tell you which grades will be need to achieve your goal. If you are on
        probation, this program will also tell you the minimum grades you will need to overcome your probation.
    </div>
