...
$title = "Privacy Policy - NSUer App";
...
<div class="fac-container addcontainer">
    <h2>Privacy Policy - NSUer App</h2>
    <p>


    <p>Hmtsoft, Inc. ("us", "we", or "our") operates the NSUer - Student Companion mobile application (the
        "Service").</p>
    ...
    <p>When you access the Service by or through a mobile device, we will not collect any personal information
        automatically or in background. During sign up, you give those information to create a new acccount. For a
        better experience, while using our Service, we may require you to provide us with certain personally
    ...
    <p>Hmtsoft, Inc. uses the collected data for various purposes:</p>
    <ul>
    ...
    <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to
        that transfer.</p>
    <p>Hmtsoft, Inc. will take all steps reasonably necessary to ensure that your data is treated securely and in
    ...
    <p>Hmtsoft, Inc. may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
    <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Hmtsoft, Inc.</li>
    ...
    <ul>
        <li>
            ...
            <p>We also encourage you to review the Google's policy for safeguarding your data: <a
                ...
                For more information on what type of information Firebase collects, please visit please visit the Google
    ...
    <ul>
        <li>By email: hm.tamim@northsouth.edu</li>
        <li>By visiting this page on our website: https://nsuer.club</li>
