...
<header class="unselectable" id="header">
    ...
    <span class="menu_icon_dot_span">
        ...
        <img id="menu_icon_dot" src="/images/app-icons/menu_dot.svg">
...
<script>
    ...
    function loadShopItem(start, loadCat, loadSearch, query, cat) {
        ...
        $.getJSON("https://nsuer.club/app/buy-sell/get-all-webapp.php?start=" + start + "&loadCat=" + loadCat + "&loadSearch=" + loadSearch + "&query=" + query + "&cat=" + cat, function (data) {
    ...
    function createPost() {
        ...
        var string = '<div class="add_course_holder">\n' +
            ...
            '            <form id="create_post_from" action="/app/newsfeed/create-post-2.php" method="POST">\n' +
    ...
    function removeCourse(key, course, section) {
        ...
        if (r == true) {
            ...
            sendPing("/app/courses/delete.php?uid=" + userUid + "&course=" + course + "." + section);
    ...
    function addCourse() {
        ...
        var string = '<div class="add_course_holder">\n' +
            ...
            '            <div class="heading_title" onclick="hideAlertWindow()">X</div></div>\n' +
            '            <form id="add_course_form" action="/app/get-course-info.php" method="GET">\n' +
            '                <input type="hidden" id="ac_uid" name="uid">\n' +
            '                <div class="inputsHolder">\n' +
    ...
    function loadEditProfile() {
        ...
        var string = '<div class="edit_profile"><div class="image_holder">\n' +
            '        <form id="upload_pic_form" action="/app/edit-profile/upload-c.php">' +
            '        <input type="hidden" name="uid" id="ep_uid_1">' +
            '            <label for="imgInp">\n' +
            '                <div class="preview_image_holder">\n' +
            '                <div class="image_croper">\n' +
            '                <img id="preview_img" src="/images/profile_picture/20.jpg"></div><div class="camera_icon">\n' +
            '                <img src="/images/app-icons/camera_dark.svg"></div></div>\n' +
            '            </label>\n' +
            '            <input type="file" accept="image/*" id="imgInp">\n' +
            '        </form>\n' +
            '    </div><form class="edit_profile_form" id="edit_profile_form" action="/app/edit-profile/edit.php" method="POST">' +
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if ($("#imgInp").val() != '') {
                        ...
                        localStorage.setItem("user_picture", localStorage.getItem("user_memebrID") + ".jpg");
                    } else {
                ...
                success: function (data) {
                    ...
                    if (isError == false) {
                        ...
                        if (localStorage.getItem('isCourse') == null) {
                            ...
                            $.getJSON("https://nsuer.club/app/sync-data-ios.php?memID=" + userData.memberID, function (data) {
                                $.each(data['dataArray'], function (key, val) {
    ...
    function fragmentFacultyPoll() {
        ...
        document.getElementById('content_pane').innerHTML += ' <iframe id="fpp_iframe" onload="myScrollTop();" class="browseFrame" src="https://nsuer.club/app/faculty-rankings.php"/>';
    ...
    function fragemntAdvisingAssistant() {
        ...
        document.getElementById('content_pane').innerHTML += ' <iframe id="aa_iframe" onload="myScrollTop();" class="browseFrame" src="https://nsuer.club/app/advising-assistant.php"/>';
    ...
    function syncAcademicCalendar() {
        $.getJSON("https://nsuer.club/app/academic-calendar/get-json.php", function (data) {
    ...
    function syncNotices() {
        $.getJSON("https://nsuer.club/app/nsu-notice-events/notice.json", function (data) {
    ...
    function syncNewsfeed(isFirst) {
        ...
        $.getJSON("https://nsuer.club/app/newsfeed/get-json-webapp.php?course=" + stringC, function (data) {
...
<script>
    function syncClassmates(isFirst) {
        ...
        $.getJSON("https://nsuer.club/app/classmates/get-json-2.php?course=" + stringC, function (data) {
    ...
    function fragmentHome() {
        ...
        if (user_picture == 0 || user_picture == "0" || user_picture == null || user_picture == "" || user_picture == "null") {
        } else {
...
<div class="hidden">
    <div id="profile_page">
        ...
        <div class="weather_class_holder cards material_shadow">
        ...
        <div class="categories">
            ...
            <table class="categories_table" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <div class="fill-class"><img src="/images/app-icons/schedule.svg"></div>
                        <br>Schedule
                    </td>
                </tr>
                <tr>
