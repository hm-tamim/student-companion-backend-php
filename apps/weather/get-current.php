...
// zP3bc2FA1uniQdrvu8ulMArwptVNMjFC redwan
...
$current = dlPage("http://dataservice.accuweather.com/currentconditions/v1/27905?apikey=" . $rand_keys . "&details=true");


file_put_contents('current.json', $current);
